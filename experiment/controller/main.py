...
def main():
    ...
    # Use "DK1" for West of Great Belt
    ...
    while True:
        ...
        log_step_to_csv(
            ...
            heating_rate=controller.thermal_system.heating_rate_k_per_step,
            cooling_coeff=controller.thermal_system.cooling_coefficient,
